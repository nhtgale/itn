...
Когда адаптер имеет кадр для отправки и линия простаивает, он немедленно передаёт кадр. Если адаптер имеет кадр для отправки и линия занята, он ждёт пока линия освободиться, и затем немедленно передаёт кадр. 
...
В стандартах на основе коаксиального кабеля адаптер слушает линию и ожидает получить из неё те же сигналы, которые он передал. Если из линии приходит сигнал, отличающийся от того, которой он передал сам, значит произошла коллизия.
