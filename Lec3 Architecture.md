...
Так, например, в модели, которую мы рассмотрели выше, уровень прикладной программы — пускай это будет браузер — реализует интерфейс, через который мы, как пользователи, взаимодействуем с сетью.
